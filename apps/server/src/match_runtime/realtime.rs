...
use super::{
    GameProjectionResponse, PersistedEffectOutcome, PersistedEffectTargetBinding,
    PersistedEventChoice, StoredGameEvent, postgres, projection_for_participant,
};
use crate::{
    AppState,
...
fn realtime_event_type(
    ...
    match (payload.event_version, stored_event_type) {
        ...
        (3, "card_played") => Ok("card_played"),
        (3, "attack_assigned") => Ok("attack_assigned"),
        (3, "card_acquired") => Ok("card_acquired"),
...
mod tests {
    ...
    use super::{realtime_event, replay_gap_requires_snapshot};
    use crate::match_runtime::StoredGameEvent;
